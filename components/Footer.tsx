        ...
        <div className="border-t border-cream-200/10 pt-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-sm text-cream-200/60 mt-5 max-w-[300px] leading-relaxed">
              ...
              <div className="flex items-center gap-3 mt-6">
                ...
                <a
                  ...
                  aria-label="WhatsApp"
                >
                  <svg className="h-4 w-4 text-cream-200/60 hover:text-cream-100" viewBox="0 0 24 24" fill="currentColor">
              ...
              <nav aria-label="Enlaces rápidos" className="flex flex-col gap-3">
                {[
                  ...
                  <Link
                    key={link.label}
                    href={link.href}
                    className="text-sm text-cream-200/60 hover:text-cream-100 transition-colors duration-300 w-fit"
                  >
                    {link.label}
                  </Link>
                ))}
            ...
            <div>
              ...
              <div className="flex flex-col gap-3.5">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2.5 text-sm text-cream-200/60 hover:text-cream-100 transition-colors duration-300 w-fit"
                >
          ...
          <div className="mt-12 pt-6 border-t border-cream-200/10 text-center">
            <span className="text-xs text-cream-200/30">
