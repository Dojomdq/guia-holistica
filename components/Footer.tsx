...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.03] dark:opacity-[0.06] noise-overlay pointer-events-none" />
      <div className="absolute top-0 left-1/4 w-[400px] h-[400px] bg-sage-200/20 dark:bg-sage-900/20 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-[300px] h-[300px] bg-terracotta-200/15 dark:bg-terracotta-900/15 rounded-full blur-[100px] pointer-events-none" />
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mt-6">
                <a
                  ...
                  className="flex items-center justify-center w-10 h-10 rounded-full bg-cream-200/60 dark:bg-bark-700/60 hover:bg-sage-100 dark:hover:bg-sage-900/40 hover:scale-110 transition-all duration-300"
