        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-5">
            <Link href="/" className="group inline-block">
              <h2 className="font-serif text-[clamp(2rem,3.5vw,3rem)] text-white/90 leading-[1.05] tracking-[-0.03em] group-hover:text-white transition-colors duration-300">
                Guía
                <span className="ml-2 text-sand-400/50 font-normal">de Bienestar</span>
              </h2>
            </Link>
            <p className="text-[14px] text-white/30 mt-5 max-w-[300px] leading-relaxed">
          ...
          <div className="lg:col-span-3">
            <h3 className="text-[11px] font-mono font-medium tracking-[0.14em] uppercase text-white/25 mb-5">
              Enlaces
            </h3>
            <nav className="flex flex-col gap-3">
              {[
                ...
                <Link
                  key={link.label}
                  href={link.href}
                  className="text-[14px] text-white/40 hover:text-white transition-colors duration-300 w-fit"
                >
                  {link.label}
                </Link>
              ))}
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex flex-col gap-3.5">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2.5 text-[14px] text-white/40 hover:text-white transition-colors duration-300 w-fit"
              >
