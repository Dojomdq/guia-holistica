...
export default function AdminShell({
  ...
  return (
    <div className="flex min-h-[calc(100vh-72px)]">
      ...
      <aside
        className={`fixed md:static inset-y-0 left-0 z-40 w-56 bg-bark text-cream-300 flex-shrink-0 flex flex-col transition-transform duration-500 ease-out ${
      ...
      >
                ...
                <Link
                  ...
                  className={`flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 ${
                    isActive
                      ...
                      : "text-cream-300 hover:text-cream-200 hover:bg-white/5"
                  }`}
                >
        ...
        <div className="mt-auto p-5 border-t border-white/5">
          ...
          <a
            href="/"
            target="_blank"
            className="flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm font-medium text-cream-200 hover:text-cream-200 hover:bg-white/5 transition-all duration-300 mt-0.5"
          >
            Ver sitio público
          </a>
        </div>
